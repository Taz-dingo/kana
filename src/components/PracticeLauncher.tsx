...
export default function PracticeLauncher({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-stone-900/35 px-4 py-6" onClick={onClose}>
      <div
        className="w-full max-w-3xl border border-stone-300 bg-[#fbf8f1] shadow-[0_24px_80px_rgba(28,25,23,0.16)]"
      ...
      >
        ...
        <div className="grid gap-4 px-5 py-5 sm:grid-cols-2 sm:px-7 sm:py-6">
          <button
            type="button"
